...
namespace MikroPic.EdaTools.v1.Core.Model.Board {
    ...
    /// </summary>
    /// 
    public sealed class EdaLayer : IVisitable<IBoardVisitor> {
        ...
        /// 
        public EdaLayer(EdaLayerId id, BoardSide side, LayerFunction function) {
        ...
        /// 
        public EdaLayer Clone() {

            return new EdaLayer(_id, _side, _function);
        }
